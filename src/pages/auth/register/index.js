...
import { SIGNIN, WEBSITE } from "../../../config/constants/routePathConstants";
import { API_ROOT, SIGNUP_API } from "../../../config/constants/apiConstant";
...
const Register = () => {
  ...
  return (
    <div className="login-container">
            ...
            <form>
              ...
              <div className="lisence-argrement">
                ...
                >
                  ...
                  />
                  <p>
                    By clicking on “I Accept”, you hereby accept and acknowledge
                    the{" "}
                    <span onClick={() => setOpenBox(true)}>
                      Terms of Services, License Agreement
                    </span>{" "}
                    and
                    <span onClick={() => setOpenBox(true)}>
                      {" "}
      ...
      >
        <Box className="success-Modal">
          ...
          <DialogContent sx={{ padding: 0 }}>
            ...
            >
              We have sent an activation link to your account to continue with
      ...
      >
        <Box className="verify-email-Modal">
          ...
          <DialogContent sx={{ padding: 0 }} className="verify-email-content">
            ...
            <DialogContentText
              id="alert-dialog-description"
              className="verify-email-description"
            >
              An email has been sent to Testadomain@radiant.com with a link to
              verify your account.
              <br /> If you have not received the email after a few minutes,
              please Resend Email
            </DialogContentText>
          </DialogContent>
      ...
      {/* //terms and condition */}
      <TermsAndCondition openBox={openBox} setOpenBox={setOpenBox}/>
    </div>
  );
};
