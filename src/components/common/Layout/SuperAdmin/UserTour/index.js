...
const steps = [
    ...
    },
    {
        ...
        content: 'Here you can see your all listed clients also add new client in your list.',
        placement: 'right',
        spotlightPadding: 0,
        styles: {
            tooltip: {
    ...
    },
    {
        ...
        title: 'Assessment',
        content: 'Here you can manage for assessment and also create new assessment.',
        placement: 'right',
        spotlightPadding: -6,
        styles: {
            tooltip: {
